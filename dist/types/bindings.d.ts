 ...
 */
export type BindingCondition = "none" | "always" | "visible" | "once" | "always_when_visible" | "visibility_changed";
/**
 ...
 * ```
 */
export declare function createGlobalBinding(bindingName: string, condition?: BindingCondition): Binding;
/**
 ...
 * ```
 */
export declare function createViewBinding(sourceExpression: string, targetProperty: string): Binding;
/**
 ...
 * ```
 */
export declare function createCollectionBinding(bindingName: string, collectionName: string, override?: string): Binding;
/**
 ...
 * ```
 */
export declare function createVisibilityBinding(condition: string): Binding;
/**
 ...
 * ```
 */
export declare function createEnabledBinding(condition: string): Binding;
