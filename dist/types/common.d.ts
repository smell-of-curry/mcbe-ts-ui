 ...
 */
export type PercentValue = PercentParent | PercentChildren | PercentChildMax | PercentSibling | PercentHeight | PercentWidth;
/**
 ...
 */
export type SizeExpression = `${number}%${PercentSuffix} ${"+" | "-"} ${number}px`;
/**
 ...
 */
export type SizeValue = PixelValue | PixelString | PercentValue | SizeExpression | FillValue | DefaultValue;
/**
 ...
 */
export type OffsetValue = PixelValue | PixelString | PercentParent | NegativePercentParent | PercentWidth | PercentHeight | SizeExpression | AnyPercent;
/**
 ...
 */
export type FontType = "default" | "smooth" | "rune" | "unicode" | "MinecraftTen" | "MinecraftSeven";
/**
