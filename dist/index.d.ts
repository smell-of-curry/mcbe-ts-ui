...
import { type VanillaScreen } from "./types/vanilla-screens";
/**
 ...
 *
 */
export declare function defineUI<NS extends NamespaceBuilder>(namespaceName: string, builder: ((ns: NamespaceBuilder) => NS) | ElementBuilder<string>, options?: {
    filename?: string;
    subdir?: string;
}): NS;
/**
 ...
 */
export declare function redefineUI<NS extends NamespaceBuilder>(screen: VanillaScreen, builder: (ns: NamespaceBuilder) => NS): NS;
