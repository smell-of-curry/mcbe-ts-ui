...
import type { ElementBuilder, NamespaceElement, PanelBuilder, StackPanelBuilder, GridBuilder, LabelBuilder, BoundLabelBuilder, ImageBuilder, BoundImageBuilder, ButtonBuilder, ToggleBuilder, CustomBuilder, FactoryBuilder, ScrollViewBuilder, ScreenBuilder, InputPanelBuilder, EditBoxBuilder, SliderBuilder } from "./element";
...
type BuilderRegistry<N extends string> = [
    [
        BoundImageBuilder<string>,
        BoundImageBuilder<N>
    ],
    [
        BoundLabelBuilder<string>,
        BoundLabelBuilder<N>
    ],
    [
        ImageBuilder<string>,
    ...
    [
        ScreenBuilder<string>,
        ScreenBuilder<N>
    ],
    [
        StackPanelBuilder<string>,
        StackPanelBuilder<N>
    ],
    [
        GridBuilder<string>,
    ...
    [
        ScrollViewBuilder<string>,
        ScrollViewBuilder<N>
    ],
    [
        InputPanelBuilder<string>,
        InputPanelBuilder<N>
    ],
    [
        EditBoxBuilder<string>,
        EditBoxBuilder<N>
    ],
    [
        SliderBuilder<string>,
        SliderBuilder<N>
    ],
    [
        PanelBuilder<string>,
...
] ? T extends Match ? Result : FindAndRemap<T, Rest> : ElementBuilder<string>;
/**
 ...
 */
type RemapBuilderName<T extends ElementBuilder<string>, N extends string> = FindAndRemap<T, BuilderRegistry<N>>;
/**
...
export declare class NamespaceBuilder<TElements extends Record<string, NamespaceElement<ElementBuilder<string>>> = EmptyElements> implements INamespaceBuilder {
     ...
     */
    add<B extends ElementBuilder<N>, N extends string>(builder: B): [
        NamespaceElement<B>,
     ...
     * ```
     */
    setMain<B extends ElementBuilder<N>, N extends string>(builder: B): NamespaceBuilder<TElements & Record<N, NamespaceElement<B>>>;
    /**
     ...
     * ```
     */
    addRaw(name: string, element: Partial<UIElement> | Record<string, unknown>): this;
    /**
     ...
     * ```
     */
    modify(elementPath: string, modifications: Partial<UIElement> | Record<string, unknown>): this;
    /**
 ...
 * ```
 */
export declare function namespace(name: string): NamespaceBuilder;
/**
 ...
 * ```
 */
export declare function extend<T extends ElementBuilder<string>, N extends string>(name: N, element: NamespaceElement<T>): RemapBuilderName<T, N>;
/**
 ...
 * ```
 */
export declare function extendExternal<T extends ElementBuilder<string>, N extends string>(name: N, element: NamespaceElement<T>): RemapBuilderName<T, N>;
/**
 ...
 * ```
 */
export declare function nsRef(namespace: string, element: string): string;
/**
 ...
 * ```
 */
export declare function animRef(namespace: string, animationName: string): string;
export {};
