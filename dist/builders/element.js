...
exports.SliderBuilder = exports.EditBoxBuilder = exports.InputPanelBuilder = exports.ScreenBuilder = exports.ScrollViewBuilder = exports.FactoryBuilder = exports.CustomBuilder = exports.ToggleBuilder = exports.ButtonBuilder = exports.BoundImageBuilder = exports.ImageBuilder = exports.BoundLabelBuilder = exports.LabelBuilder = exports.GridBuilder = exports.StackPanelBuilder = exports.PanelBuilder = exports.ElementBuilder = exports.NamespaceElement = void 0;
// ============================================================================
...
class NamespaceElement {
     ...
     */
    constructor(builder, namespaceName) {
...
exports.NamespaceElement = NamespaceElement;
// ============================================================================
...
class ElementBuilder {
    ...
    _createForExtension(name) {
        const instance = new this.constructor(name);
        // Clear the type - it's inherited from the extended element
        delete instance.properties.type;
    ...
    getFullName() {
        if (this.extendsRef)
            return `${this.elementName}@${this.extendsRef}`;
        return this.elementName;
    }
    /**
     ...
     * ```
     */
    extends(reference, shouldClearType = true) {
     ...
     */
    extendsFrom(element) {
        return this.extends(element.getQualifiedName(), element.builder.type !== undefined);
    }
    /**
    ...
    size(width = "default", height = "default") {
        if (width == "100%" || height == "100%")
            console.warn("Optimization note: Size set of 100% is not needed, as thats the default value.");
        const isChildPadding = (typeof width === "string" && width.includes("%c + ")) ||
            (typeof height === "string" && height.includes("%c + "));
        if (isChildPadding)
            console.warn("Optimization note: Use .padChildren() instead of .size() when setting child padding.");
     ...
     * ```
     */
    sizePercent(width = 100, height = 100) {
     ...
     * ```
     */
    padChildren(horizontal, vertical) {
    ...
    anchor(anchor) {
        if (anchor == "center")
            console.warn("Optimization note: Anchor set of center is not needed, as thats the default value.");
        this.properties.anchor_from = anchor;
        this.properties.anchor_to = anchor;
        return this;
    }
    ...
    alpha(value) {
        if (value == 1)
            console.warn("Optimization note: Alpha set of 1 is not needed, as thats the default value.");
     ...
     * ```
     */
    globalBinding(bindingName, override, condition = "none") {
        return this.bindings({
            binding_type: "global",
     ...
     * ```
     */
    viewBinding(sourceProperty, targetProperty) {
        return this.bindings({
            binding_name: "#null",
            binding_type: "view",
     ...
     * ```
     */
    collectionBinding(bindingName, collectionName, override) {
        return this.bindings({
            binding_name: bindingName,
    ...
    buttonMappings(...mappings) {
        if (!this.properties.button_mappings)
            this.properties.button_mappings = [];
     ...
     * ```
     */
    globalButtonMapping(fromButton, toButton) {
     ...
     */
    modifications(...mods) {
        if (!this.properties.modifications)
            this.properties.modifications = [];
     ...
     * ```
     */
    insertFront(arrayName, ...controls) {
        return this.modifications({
            array_name: arrayName,
     ...
     * ```
     */
    insertAfter(controlName, ...controls) {
        return this.modifications({
     ...
     * ```
     */
    insertBefore(controlName, ...controls) {
        return this.modifications({
            control_name: controlName,
     ...
     */
    anims(...animRefs) {
        if (!this.properties.anims)
            this.properties.anims = [];
     ...
     * ```
     */
    variable(name, value, isDefault = false) {
     ...
     * ```
     */
    variables(vars, isDefault = false) {
    ...
    focusNavigation(options) {
        if (options.up)
            this.properties.focus_change_up = options.up;
        if (options.down)
            this.properties.focus_change_down = options.down;
        if (options.left)
            this.properties.focus_change_left = options.left;
        if (options.right)
            this.properties.focus_change_right = options.right;
        return this;
    }
    // -------------------------------------------------------------------------
    // Raw Properties
 ...
 * ```
 */
class StackPanelBuilder extends ElementBuilder {
    /**
...
exports.StackPanelBuilder = StackPanelBuilder;
/**
 ...
 * ```
 */
class GridBuilder extends ElementBuilder {
    /**
...
class LabelBuilder extends ElementBuilder {
    ...
    fontSize(value) {
        if (value == "normal")
            console.warn("Optimization note: Font size set of normal is not needed, as thats the default value.");
    ...
    fontScaleFactor(value) {
        if (value == 1)
            console.warn("Optimization note: Font scale factor set of 1 is not needed, as thats the default value.");
        return this.setProp("font_scale_factor", value);
    }
    /**
     ...
     * @returns This builder for method chaining.
     */
    enableProfanityFilter(value = true) {
        return this.setProp("enable_profanity_filter", value);
    }
}
exports.LabelBuilder = LabelBuilder;
class BoundLabelBuilder extends LabelBuilder {
    constructor(name, bindingName = "text") {
        super(name);
     ...
     */
    _createForExtension(name) {
        return new BoundLabelBuilder(name, this.bindingName);
    }
}
exports.BoundLabelBuilder = BoundLabelBuilder;
/**
...
class BoundImageBuilder extends ImageBuilder {
     ...
     */
    _createForExtension(name) {
        return new BoundImageBuilder(name, this.bindingName);
    }
}
exports.BoundImageBuilder = BoundImageBuilder;
/**
...
class ButtonBuilder extends ElementBuilder {
    ...
    controlStates(states) {
        if (states.default)
            this.defaultControl(states.default);
        if (states.hover)
            this.hoverControl(states.hover);
        if (states.pressed)
            this.pressedControl(states.pressed);
        if (states.locked)
            this.lockedControl(states.locked);
        return this;
    }
}
 ...
 */
class CustomBuilder extends ElementBuilder {
    /**
     ...
     * @returns This builder for method chaining.
     */
    anchoredOffsetEnabled(value = true) {
 ...
 * ```
 */
class FactoryBuilder extends ElementBuilder {
    /**
 ...
 * ```
 */
class ScrollViewBuilder extends ElementBuilder {
    /**
     ...
     * @returns This builder for method chaining.
     */
    jumpToBottomOnUpdate(value = true) {
...
exports.ScrollViewBuilder = ScrollViewBuilder;
/**
 ...
 * ```
 */
class ScreenBuilder extends ElementBuilder {
    /**
     ...
     * @returns This builder for method chaining.
     */
    closeOnPlayerHurt(value = true) {
        return this.setProp("close_on_player_hurt", value);
    }
}
exports.ScreenBuilder = ScreenBuilder;
/**
 ...
 * ```
 */
class InputPanelBuilder extends ElementBuilder {
    /**
     ...
     * @returns This builder for method chaining.
     */
    consumeEvent(value = true) {
        return this.setProp("consume_event", value);
    }
}
exports.InputPanelBuilder = InputPanelBuilder;
/**
 ...
 * ```
 */
class EditBoxBuilder extends ElementBuilder {
    /**
     ...
     * @returns This builder for method chaining.
     */
    placeholderControl(name) {
        return this.setProp("place_holder_control", name);
    }
}
exports.EditBoxBuilder = EditBoxBuilder;
/**
 ...
 * ```
 */
class SliderBuilder extends ElementBuilder {
    /**
     ...
     * @returns This builder for method chaining.
     */
    sliderBoxControl(name) {
        return this.setProp("slider_box_control", name);
    }
}
exports.SliderBuilder = SliderBuilder;
