 ...
 * ```
 */
export { ElementBuilder, NamespaceElement, PanelBuilder, StackPanelBuilder, GridBuilder, LabelBuilder, ImageBuilder, ButtonBuilder, ToggleBuilder, CustomBuilder, FactoryBuilder, ScrollViewBuilder, ScreenBuilder, InputPanelBuilder, EditBoxBuilder, SliderBuilder, } from "./element";
export { NamespaceBuilder, namespace, ref, extend, extendExternal, extendRaw, fromBuilder, nsRef, animRef, } from "./namespace";
export { AnimationBuilder, animation } from "./animation";
import { PanelBuilder, StackPanelBuilder, GridBuilder, LabelBuilder, ImageBuilder, ButtonBuilder, ToggleBuilder, CustomBuilder, FactoryBuilder, ScrollViewBuilder, ScreenBuilder, InputPanelBuilder, EditBoxBuilder, SliderBuilder, ElementBuilder, BoundLabelBuilder, BoundImageBuilder } from "./element";
/**
 ...
 * ```
 */
export declare function panel<N extends string>(name: N): PanelBuilder<N>;
/**
 ...
 * ```
 */
export declare function stackPanel<N extends string>(name: N, orientation: "horizontal" | "vertical"): StackPanelBuilder<N>;
/**
 ...
 * ```
 */
export declare function grid<N extends string>(name: N): GridBuilder<N>;
/**
 ...
 * ```
 */
export declare function label<N extends string>(name: N, text: string): LabelBuilder<N>;
/**
 ...
 * @returns
 */
export declare function boundLabel<N extends string>(name: N, bindingName?: string): BoundLabelBuilder<N>;
/**
 ...
 * ```
 */
export declare function image<N extends string>(name: N, texture: string): ImageBuilder<N>;
/**
 ...
 * @returns
 */
export declare function boundImage<N extends string>(name: N, bindingName?: string): BoundImageBuilder<N>;
/**
 ...
 * ```
 */
export declare function button<N extends string>(name: N): ButtonBuilder<N>;
/**
 ...
 * ```
 */
export declare function toggle<N extends string>(name: N): ToggleBuilder<N>;
/**
 ...
 * ```
 */
export declare function custom<N extends string>(name: N): CustomBuilder<N>;
/**
 ...
 * ```
 */
export declare function factory<N extends string>(name: N): FactoryBuilder<N>;
/**
 ...
 * ```
 */
export declare function scrollView<N extends string>(name: N): ScrollViewBuilder<N>;
/**
 ...
 * ```
 */
export declare function screen<N extends string>(name: N): ScreenBuilder<N>;
/**
 ...
 * ```
 */
export declare function inputPanel<N extends string>(name: N): InputPanelBuilder<N>;
/**
 ...
 * ```
 */
export declare function editBox<N extends string>(name: N): EditBoxBuilder<N>;
/**
 ...
 * ```
 */
export declare function slider<N extends string>(name: N): SliderBuilder<N>;
/**
 ...
 * ```
 */
export declare function element<N extends string>(name: N): ElementBuilder<N>;
