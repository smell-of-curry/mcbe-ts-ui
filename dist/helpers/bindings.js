...
exports.collectionDetailsBinding = collectionDetailsBinding;
exports.collectionBindingNone = collectionBindingNone;
exports.viewBinding = viewBinding;
exports.siblingViewBinding = siblingViewBinding;
exports.sourceControlBinding = sourceControlBinding;
exports.variableParserBindings = variableParserBindings;
exports.textureParserBindings = textureParserBindings;
exports.visibilityBinding = visibilityBinding;
exports.enabledBinding = enabledBinding;
exports.textBinding = textBinding;
exports.textureBinding = textureBinding;
exports.globalBinding = globalBinding;
exports.titleTextBinding = titleTextBinding;
exports.hudTitleBinding = hudTitleBinding;
exports.preservedTextBinding = preservedTextBinding;
exports.factoryLengthBinding = factoryLengthBinding;
exports.siblingVisibilityBindings = siblingVisibilityBindings;
exports.buttonVisibilityBindings = buttonVisibilityBindings;
exports.titleFlagBindings = titleFlagBindings;
exports.basicTextureBindings = basicTextureBindings;
exports.textureVisibilityBinding = textureVisibilityBinding;
exports.fullTextureBindings = fullTextureBindings;
exports.buttonEnabledBindings = buttonEnabledBindings;
// ============================================================================
 ...
 * ```
 */
function collectionBinding(bindingName, collectionName = "form_buttons", override) {
    return {
 ...
 */
function collectionDetailsBinding(collectionName = "form_buttons") {
    return {
        binding_name: "#null",
 ...
 */
function collectionBindingNone(collectionName = "form_buttons") {
    return {
        binding_name: "#null",
        binding_type: "collection",
 ...
 * ```
 */
function viewBinding(sourceExpression, targetProperty, sourceControl) {
    const binding = {
        binding_name: "#null",
        binding_type: "view",
 ...
 * ```
 */
function siblingViewBinding(sourceControl, sourceExpression, targetProperty) {
    return {
        binding_name: "#null",
        binding_type: "view",
 ...
 * ```
 */
function sourceControlBinding(sourceControl, sourceProperty, targetProperty) {
    return {
        binding_name: "#null",
        binding_type: "view",
        source_control_name: sourceControl,
 ...
 * ```
 */
function variableParserBindings(sourceControl = "elements", sourceProperty = "#sidebar") {
    return [
 ...
 */
function textureParserBindings(sourceControl, sourceProperty, textureBasePath, varName = "#texture_var") {
    return [
        sourceControlBinding(sourceControl, sourceProperty, "#string"),
 ...
 * ```
 */
function visibilityBinding(condition) {
 ...
 */
function enabledBinding(condition) {
 ...
 */
function textBinding(expression) {
 ...
 */
function textureBinding(expression) {
 ...
 * ```
 */
function globalBinding(bindingName, override, condition = "none") {
    return {
        binding_type: "global",
        binding_name: bindingName,
        binding_name_override: override ?? bindingName,
 ...
 */
function factoryLengthBinding(collectionLengthBinding = "#form_button_length") {
    return {
 ...
 */
function siblingVisibilityBindings(controlName, sourceProperty, targetProperty = "#visible") {
 ...
 */
function buttonVisibilityBindings(flagExpression, collectionName = "form_buttons") {
    return [
 ...
 */
function titleFlagBindings(flagExpression) {
    return [
        globalBinding("#title_text"),
        visibilityBinding(flagExpression),
 ...
 */
function basicTextureBindings(collectionName = "form_buttons") {
    return [
        collectionBinding("#form_button_texture", collectionName, "#texture"),
        collectionBinding("#form_button_texture_file_system", collectionName, "#texture_file_system"),
    ];
}
/**
 ...
 */
function textureVisibilityBinding() {
 ...
 */
function fullTextureBindings(collectionName = "form_buttons") {
 ...
 * @returns Array of bindings
 */
function buttonEnabledBindings(enabledExpression, collectionName = "form_buttons") {
    return [
